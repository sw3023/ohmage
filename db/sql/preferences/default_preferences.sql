...
2. The UCLA IRB information can be found here: http://ohrpp.research.ucla.edu/pages/about-irb
    ...
    ('mail_password_reset_text', '<h3>Password Reset</h3><p>Your password has been reset. Please login below with the temporary password sent to you via email. You will then be prompted to create a new password. </p>');
